...
**Updated assignment details can be found [here]()**
...
1. Peer-feedback session: you will exchange an outline of your project idea (i.e. which problem do you want to address and how?) with a fellow student. The purpose of the peer feedback is to get an independent view on your project early in the process. We will provide templates for the feedback that you will give and receive. The peer-feedback session will be held **at end of the lecture on 11 Feb. 2019**.
