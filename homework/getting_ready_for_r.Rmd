...
Please follow this guide [here (http://web.cs.ucla.edu/~gulzar/rstudio/)](http://web.cs.ucla.edu/~gulzar/rstudio/) to install R Studio (and the required core R) on your machine.
